...
- [dsh-mneme](https://github.com/modusensus/dsh-mneme) - Cross-session memory plugin for DSH: SQLite + Markdown mirrors, autoDream self-consolidation (dedup/merge/conflict), Sleep Mode deep maintenance (v0.4.0), entity-attribute timeline (v0.3.0), local vector/Rerank/clustering semantic search, custom summarize model (v0.4.2), Web GUI panel — 473 tests passed, ⭐ 22.
